...
/**
 * Found at
 * https://github.com/awsdocs/aws-doc-sdk-examples/blob/main/javav2/example_code/sns/src/main/java/com/example/sns/SNSMessageFilterPolicy.java
 */
public class SNSMessageFilterPolicy {
  ...
  public <T extends Number> void addAttribute(
      final String attributeName, final String op, final T value) {
    filterPolicy.put(
        attributeName, new Attribute<>(AttributeType.Numeric, new NumericValue<>(op, value)));
  }
  ...
  private class NumericValue<T extends Number> {
    ...
    public String toString() {
      final StringBuilder s =
          new StringBuilder("[").append('\"').append(lowerOp).append("\",").append(lower);
      if (upper != null) {
